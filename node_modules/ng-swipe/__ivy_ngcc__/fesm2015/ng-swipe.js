...
SwipeDirective.ɵfac = function SwipeDirective_Factory(t) { return new (t || SwipeDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
SwipeDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: SwipeDirective, selectors: [["", "ngSwipe", ""]], outputs: { swipeMove: "swipeMove", swipeEnd: "swipeEnd" } });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SwipeDirective, [{
        type: Directive,
        args: [{
                selector: '[ngSwipe]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }]; }, { swipeMove: [{
            type: Output
        }], swipeEnd: [{
            type: Output
        }] }); })();
...
SwipeModule.ɵfac = function SwipeModule_Factory(t) { return new (t || SwipeModule)(); };
SwipeModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: SwipeModule });
SwipeModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SwipeModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SwipeModule, { declarations: [SwipeDirective], exports: [SwipeDirective] }); })();

export { SwipeModule, SwipeDirective as ɵa };
